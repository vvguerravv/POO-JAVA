...
public class TermometroTest {
    ...
    public void testarDiferenca(){
        ...
        assertEquals(20,t.diferenca(new Termometro(20,30,10,'F'),'K'));
    }
    ...
    public void testarRetornaDados(){
        ...
        assertEquals("Temperatura atual: 30 °C // Temperatura minima: 0 °C // Temperatura máxima: 100 °C",t.informacoes('C'));
    }
